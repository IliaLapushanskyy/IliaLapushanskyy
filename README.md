...
|-------------|----------|
| [Диагностика диабета]([https://github.com/ваш-юзернейм/репозиторий1](https://github.com/IliaLapushanskyy/Diabet_sklearn)) | *End-to-end решение** для предсказания диабета по медицинским показателям. В работе производился аналих данных, изучение особенностей признаков, обучение и сравнение различных ML моделей. ||
