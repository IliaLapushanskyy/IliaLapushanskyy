...
|-------------|----------|
| [Диагностика диабета]([https://github.com/IliaLapushanskyy/Diagnosis-of-diabetes)) | *End-to-end решение** для предсказания диабета по медицинским показателям. В работе производился аналих данных, изучение особенностей признаков, обучение и сравнение различных ML моделей. ||
