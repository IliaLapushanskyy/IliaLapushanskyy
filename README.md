...
|-------------|----------|
| [Диагностика диабета по медицинским данным](https://github.com/IliaLapushanskyy/Diagnosis-of-diabetes) | **End-to-end решение** для предсказания диабета по медицинским показателям. В работе производился анализ данных, изучение особенностей признаков, обучение и сравнение различных ML моделей. |
